...
@ImplementedBy(classOf[DefaultSkriesimIntegrationService])
...
class DefaultSkriesimIntegrationService @Inject()(skriesimDataService: SkriesimDataService,
                                                  val ageGroupRepository: AgeGroupRepository,
                                                  val raceRepository: RaceRepository,
                                                  personRepository: PersonRepository,
                                                  clubRepository: ClubRepository,
                                                  personsClubsRepository: PersonsClubsRepository,
                                                  personsCoachesRepository: PersonsCoachesRepository,
                                                  ...
                                                  raceResultRepository: RaceResultRepository) extends SkriesimIntegrationService with SkriesimImportUtils {
