...
import models.skriesim.{Athlete, Club, NonStandardDistance, Race}
import play.api.Logger
import services.skriesim.parsers.SkriesimParser
import services.skriesim.providers.SkriesimProvider

@ImplementedBy(classOf[DefaultSkriesimDataService])
...
class DefaultSkriesimDataService @Inject()(skriesimProvider: SkriesimProvider,
                                           skriesimParser: SkriesimParser) extends SkriesimDataService {
